...
public class OAuthDemoApp {

    private static final Logger log = LoggerFactory.getLogger(OAuthDemoApp.class);

    private final Environment env;

    public OAuthDemoApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes oAuthDemo.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(OAuthDemoApp.class);
